						...
						<div class="loop-nav-inner">
							<?php 
            					...
            					if ($current_page > 1 && $total_page > 1){
               						echo '<a  class="prev" href="theloai.php?page='.($current_page-1).'&id_theloai='.$_GET['id_theloai'].'">Quay Lại</a> | ';
           						}
            					else{
            					...
            					for ($i = 1; $i <= $total_page; $i++){
                					...
                					if ($i == $current_page){
                    					...
                    					echo '<a  href="theloai.php?page='.$i.'&id_theloai='.$_GET['id_theloai'].'">'.$i.'</a> | ';
                					}
            					}
            					// nếu current_page < $total_page và total_page > 1 mới hiển thị nút Xem Thêm
            					if ($current_page < $total_page && $total_page > 1){
                					echo '<a class="next" href="theloai.php?page='.($current_page+1).'&id_theloai='.$_GET['id_theloai'].'">Xem Thêm</a> | ';
            					}
            					else{
